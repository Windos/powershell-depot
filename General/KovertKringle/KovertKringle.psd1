@{
    RootModule = 'KovertKringle.psm1'
    ModuleVersion = '0.0.1'
    GUID = 'f518b1c4-67ae-43b3-b759-239b17dd7cb9'
    ...
    PrivateData = @{
        PSData = @{
            Tags = @('Christmas', 'Secret Santa')
            LicenseUri = 'https://github.com/Windos/powershell-depot/blob/master/LICENSE.md'
            ProjectUri = 'https://github.com/Windos/powershell-depot/tree/master/General/KovertKringle'
            # IconUri = ''
            ReleaseNotes = '
* 0.0.1
    * Initial release
