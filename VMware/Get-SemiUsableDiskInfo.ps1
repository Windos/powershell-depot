...
#>
    ...
    process
	{
        ...
        foreach ($computer in $computername)
		{
            ...
            # Performing a little preparation on the information gathered so far
            ...
            foreach ($info in $gatheredInformation)
			{
                ...
                if ($parent -eq 'Disk&Ven_VMware&Prod_Virtual_disk')
				{
                    ...
                    # Loop through all SCSI controllers, as discovered using the current target's VM Extensiondata
